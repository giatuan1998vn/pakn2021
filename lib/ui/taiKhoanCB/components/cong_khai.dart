...
class congKhai extends StatefulWidget {
  final int id;


  congKhai({Key key, this.id}) : super(key: key);
  @override
  _tuChoiState createState() => _tuChoiState();
}

class _tuChoiState extends State<congKhai> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Công khai phản ánh kiến nghị"),),
              ...
              children: [
                ...
                Padding(padding: EdgeInsets.only(left: 10,right: 10,top: 0),
                  child:   TextButton.icon (
                      ...
                      label: Text('Công khai',style: TextStyle(fontWeight:
                      FontWeight.bold)),
                      onPressed: () async {
                          ...
                          //     .text.toString();
                          var thanhcong = await
                          CongAPI.postCongKhai(widget.id,"CongKhai",);
                          EasyLoading.dismiss();
