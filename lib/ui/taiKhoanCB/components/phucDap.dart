...
class phucDap extends StatefulWidget {
  final int id;

  phucDap({Key key, this.id}) : super(key: key);

  @override
  _tuChoiState createState() => _tuChoiState();
}

class _tuChoiState extends State<phucDap> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Phúc đáp phản ánh kiến nghị"),
      ),
                          ...
                          builder: (context) =>
                              AlertDialog(
                                ...
                                content: SingleChildScrollView(
                                    child: Text("Bạn có muốn phúc đáp không!")),
                                actions: <Widget>[
                                  TextButton(
                                    child: Text('Yes'),
                                    onPressed: () async {
                                      ...
                                      //     .text.toString();
                                      var thanhcong = await
                                      CongAPI.postTuChoi(widget.id,"PhucDapCongKhaiPAKN",
                                        TiengViet,TiengAnh,
                                        TiengTrung,
                                        TiengNhat,TiengHan,);
                                  ...
                                  TextButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      // var thoiGian = _dateController
                                      //     .text.toString();
                                      var thanhcong = await CongAPI.postTuChoi(
                                        widget.id,
                                        "PhucDapPAKN",
                                        TiengViet,
                                        TiengAnh,
