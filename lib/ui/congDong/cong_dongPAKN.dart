...
class congDongPAKN extends StatefulWidget {
  final String TrangThaiXuLy;
  final String LoaiTiepNhan;
  final String CongKhai;
  final String NguoiHoi;
  congDongPAKN({this.TrangThaiXuLy,this.LoaiTiepNhan,this.CongKhai,this.NguoiHoi});
  @override
  _congDongState createState() => _congDongState();
}

class _congDongState extends State<congDongPAKN> {
  List dataList = [];
  ...
  GetDataDL(String trangthai) async {
    String getData= await CongAPI.getDataDetailVBPAKN(ActionXL,length,widget
        .TrangThaiXuLy,widget.LoaiTiepNhan,widget.CongKhai,widget.NguoiHoi);
    if (mounted) {
      setState(() {
                          ...
                          Row(children: [ Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(fontSize: 10, color: Color
                                (0xff0099FF).withOpacity(0.7), fontWeight:
                              FontWeight.w400,
                                fontStyle: FontStyle.normal,),
                              overflow: TextOverflow.ellipsis,
