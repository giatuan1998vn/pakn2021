...
class thongTinCaNhan extends StatefulWidget {
  ...
  thongTinCaNhan({Key key, this.id, this.title}) : super(key: key);
...
class _thongTinCaNhanState extends State<thongTinCaNhan> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Nội dung chi tiết phản ánh cá nhân'.toUpperCase(),
          style: TextStyle(
              color: Colors.white,
              fontSize: 16,
      ...
      children: [
        Column(
          ...
          children: [
            ...
            // dataListBL != null &&dataListBL.length >0  ?Container(
  ...
  Widget getBodyPhucDap(json) {
    ...
    if (datas != null) {
      tong = (SoDiem1 + SoDiem2 + SoDiem3 + SoDiem4 + SoDiem5) / 5;
      print(tong.toString());
      print(SoDiem2.toString());
      print(datas.toString());
    }

    var tenCoQuanPD = json['TraLoiCoQuanTraLoi'] != null
        ? json['TraLoiCoQuanTraLoi']['LookupValue']
        : "";
    var TraLoiTiengVietPD =
    json['TraLoiTiengViet'] != null ? json['TraLoiTiengViet'] : "";
    var ThoiGianTaoPD =
    json['TraLoiNgayTraLoi'] != null ? json['TraLoiNgayTraLoi'] : "";
    var DiaChi = json['DiaChi'] != null ? json['DiaChi'] : "";
    var DonViT = json['TraLoiCoQuanTraLoi'] != null
        ? json['TraLoiCoQuanTraLoi']['LookupId']
        : 0;
            ...
            Container(
                ...
                child: SmoothStarRating(
                  ...
                  onRated: (value) async {
                    var thanhcong = null;
                    thanhcong;
                    // = await CongAPI.getDataDanhGia(id, value.toInt(), DonViT);
                    Navigator.of(context).pop();
